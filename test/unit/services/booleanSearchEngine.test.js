...
describe('booleanSearchEngine.test.js', function() { 'use strict';
    ...
    // xdescribe('Check generate expression tree like an object:', function(){
    ...
    // xdescribe('When search title pattern contains OR expression - will try to find one of the search', function(){
    //     var bookmark, searchText;
    ...
    // xdescribe('When search url pattern contains OR expression - will try to find one of the search', function(){
    //     var bookmark, searchText;
    ...
    // xdescribe('When search tag pattern contains OR expression - will try to find one of the search', function(){
    //     var bookmark, searchText;
